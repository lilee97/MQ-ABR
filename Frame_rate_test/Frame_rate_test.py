...
NN_MODEL = '../results/actor_nn_model_ep_55200.pkl'
...
def main():
    ...
    while True:  # serve video forever
        ...
        if 0 <= dnn_choice < 5:
            ...
            reward = bitrate_choice(bit_rate, replay_dnn_remain, last_about_dnn_choice) / M_IN_K - REBUF_PENALTY * rebuf - np.abs(f1 - f2) / M_IN_K
